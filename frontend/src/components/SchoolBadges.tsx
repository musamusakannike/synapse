      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-12 items-center">
          {badges.map((b) => (
            ...
            >
              <div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center shadow-sm overflow-hidden">
                <Image
                  src={b.src}
                  alt={`${b.name} badge`}
                  width={b.width}
