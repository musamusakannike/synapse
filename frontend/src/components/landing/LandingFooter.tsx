...
const LandingFooter: React.FC = () => {
  ...
  return (
    <footer
      className="landing-section py-12 md:py-16"
      ...
      <div className="landing-container">
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="max-w-xs">
            ...
            >
              AI-powered learning assistant for students. Study smarter, not harder.
            </p>
            ...
            <div className="flex gap-4">
              ...
              {/* GitHub */}
              <a
                href="https://github.com/musamusakannike/synapse"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-colors"
                style={{ color: "var(--l-muted)" }}
        ...
        >
          <p className="text-xs" style={{ color: "var(--l-muted)" }}>
            &copy; {currentYear} Synapse. Built in Ilorin, Nigeria.
          </p>
          <p className="text-xs" style={{ color: "var(--l-muted)" }}>
