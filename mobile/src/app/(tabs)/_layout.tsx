...
import { IconHome, IconBook, IconTrendingUp, IconBell, IconUser } from '@tabler/icons-react-native';
...
export default function TabsLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="notifications" options={{ title: 'Alerts', tabBarIcon: ({ color }) => <IconBell size={22} color={color} /> }} />
