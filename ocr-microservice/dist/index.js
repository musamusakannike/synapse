...
app.post("/process-document", async (req, res) => {
    try {
        ...
        await db.collection("documents").updateOne({ _id: doc._id }, { $set: { ocrStatus: "processing", ocrError: null } });
        ...
        (async () => {
            ...
            try {
                ...
                await db.collection("documents").updateOne({ _id: docObjId }, {
                    $set: {
                        extractedText,
                        ocrStatus: "completed",
                        ocrError: null,
