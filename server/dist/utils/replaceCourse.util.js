...
const courseSeed = {
    course: {
        ...
        longDescription: 'A hands-on Python course that walks you through core concepts one small step at a time — reading, watching, answering quizzes, and running real code in the browser — before moving to the next idea.',
    ...
    topics: [
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: "Fun fact: almost every programmer's very first program says \"Hello, world!\" — it's a tradition! You just wrote the same first program that millions of programmers before you have written.\n\nQuick recap so far:\n- Code = instructions for the computer.\n- The computer does EXACTLY what you say — nothing more, nothing less.\n- print(\"...\") shows a message on the screen.",
                },
                {
                    type: 'exercise',
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Use print() to display your own name on the screen. Replace the blank space inside the quotes with your name, then run the code.',
                        starterCode: 'print("   ")',
                        language: 'python',
                        expectedOutput: '',
                        solution: 'print("Ada")',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'The code below has a SyntaxError because it is missing a closing quotation mark. Fix it so it runs without an error and prints: I fixed the error!',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Create a variable called age set to a whole number (int), and a variable called height set to a decimal number (float, e.g. 1.75). Print both.',
                        starterCode: 'age = 0\nheight = 0.0\nprint(age)\nprint(height)',
                        language: 'python',
                        expectedOutput: '',
                        solution: 'age = 25\nheight = 1.75\nprint(age)\nprint(height)',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'The variable name below breaks the naming rules because it has a space. Fix it using snake_case (lowercase words joined with an underscore), then print it.',
            ...
            contents: [
                {
                    ...
                    content: "Think of Python as a very fast, very obedient calculator. Just like a calculator, you can hand it numbers and an operation, and it gives you the answer instantly — but remember our main rule from Module 1: it only does exactly what you tell it, so the symbols you use matter a lot.\n\nLet's start with the four operators you already know from school:\n+  addition (add two numbers)\n-  subtraction (take one number from another)\n*  multiplication (multiply two numbers) — note it's *, not x\n/  division (divide one number by another)\n\nExample:\nprint(5 + 3)   # shows 8\nprint(10 - 4)  # shows 6\nprint(6 * 2)   # shows 12\nprint(9 / 2)   # shows 4.5\n\nMain point (remember it): +, -, *, / work just like in maths class, except multiplication uses * and NOT x.",
                },
                {
                    type: 'code',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'You have 20 sweets to share equally among 3 friends. Print how many whole sweets each friend gets (use //), then print how many are left over (use %).',
                        starterCode: 'print(0)\nprint(0)',
                        language: 'python',
                        expectedOutput: '6\n2',
                        solution: 'print(20 // 3)\nprint(20 % 3)',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Ask the user "Enter a number: " with input(), convert their answer to an int using int(), then print the number multiplied by 2.',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Complete the bill and tip calculator: ask for the bill amount and tip percentage using input() (convert both to float), then print the total amount to pay (bill + tip amount, where tip amount = bill * tip_percent / 100).',
                        starterCode: 'bill = float(input("Enter the bill amount: "))\ntip_percent = float(input("Enter the tip percentage: "))\n\n# calculate tip_amount and total below\n',
                        language: 'python',
                        expectedOutput: '',
                        solution: 'bill = float(input("Enter the bill amount: "))\ntip_percent = float(input("Enter the tip percentage: "))\n\ntip_amount = bill * (tip_percent / 100)\ntotal = bill + tip_amount\n\nprint("Total to pay:", total)',
                    },
                },
                {
                    type: 'quiz',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Create a variable score = 85. Print "A" if score is 80 or above, "B" if it is 60 or above (but less than 80), otherwise print "C".',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Create height = 150 and has_adult = False. Print "Can ride" if height is at least 140 AND has_adult is True, otherwise print "Cannot ride".',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Complete the grade classifier: given a variable score = 55, print "Grade: A" if score >= 80, "Grade: B" if score >= 60, "Grade: C" if score >= 40, otherwise print "Grade: F".',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Complete the guessing game: secret_number is 4. Use a while True loop that asks the user to guess (input(), converted to int), prints "Correct!" and breaks if the guess matches, otherwise prints "Try again" and keeps looping.',
                        starterCode: 'secret_number = 4\n\nwhile True:\n    guess = int(input("Guess the number: "))\n    # add your if/else and break below\n',
                        language: 'python',
                        expectedOutput: '',
                        solution: 'secret_number = 4\n\nwhile True:\n    guess = int(input("Guess the number: "))\n    if guess == secret_number:\n        print("Correct!")\n        break\n    else:\n        print("Try again")',
                    },
                },
                {
                    type: 'quiz',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Start with tasks = ["wake up", "eat"]. Add "sleep" to the end using append(), then print the list.',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Define a function called power that takes base and exponent=2 (default value of 2), and returns base ** exponent. Print power(5) and print power(2, exponent=3).',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Define a function celsius_to_fahrenheit(celsius) that returns (celsius * 9 / 5) + 32. Then print the result of calling it with 20.',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Given sentence = "Learning Python is fun", split it into words, then join the words back together using a dash "-" instead of a space, and print the result.',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'The code below crashes because "abc" cannot be converted to an int. Wrap it in a try/except so that instead of crashing, it prints "Conversion failed!"',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Wrap the division below in a try/except that specifically catches ZeroDivisionError, printing "Cannot divide by zero!" instead of crashing.',
                        starterCode: 'a = 10\nb = 0\nresult = a / b\nprint(result)',
                        language: 'python',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Create a class called Student with an __init__(self, name, age) that stores name and age using self. Create a student called student1 with name "Amara" and age 21, then print student1.name and student1.age.',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Add a method called greet(self) to the Student class that prints "Hi, I am" followed by self.name. Create student1 = Student("Tunde", 19), then call student1.greet().',
        ...
        },
        {
            ...
            contents: [
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Given the questions list below (with only one question), write ask_question(q) that asks the question with input() and returns True if the answer matches q["answer"], then print "Correct!" or "Wrong!" based on the result.',
                        starterCode: 'questions = [{"question": "What does print() do? ", "answer": "displays output"}]\n\ndef ask_question(q):\n    pass\n',
                        language: 'python',
                        expectedOutput: '',
                        solution: 'questions = [{"question": "What does print() do? ", "answer": "displays output"}]\n\ndef ask_question(q):\n    user_answer = input(q["question"])\n    return user_answer.strip() == q["answer"]\n\nif ask_question(questions[0]):\n    print("Correct!")\nelse:\n    print("Wrong!")',
                    },
                },
                {
                    type: 'quiz',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Given tasks = [], append the string "Buy groceries" to tasks, then loop through tasks and print each item with a "-" in front, like "- Buy groceries".',
                        starterCode: 'tasks = []\n',
                        language: 'python',
                ...
                },
                {
                    ...
                    content: 'Exercise',
                    exercise: {
                        instructions: 'Complete generate_password(length): use a for loop that runs length times, each time picking one random character from characters with random.choice() and adding it to password. Return password. Print generate_password(8).',
                        starterCode: 'import random\n\ncharacters = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%"\n\ndef generate_password(length):\n    password = ""\n    # add your loop here\n    return password\n\n',
                        language: 'python',
                        expectedOutput: '',
...
const run = async () => {
    try {
        ...
        if (existingCourseIds.length > 0) {
            const existingTopics = await topic_model_1.default.find({ course: { $in: existingCourseIds } });
            ...
            await Promise.all([
                ...
                userProgress_model_1.default.deleteMany({ course: { $in: existingCourseIds } }),
                studySession_model_1.default.deleteMany({ course: { $in: existingCourseIds } }),
            ]);
            await topic_model_1.default.deleteMany({ course: { $in: existingCourseIds } });
            await course_model_1.default.deleteMany({ _id: { $in: existingCourseIds } });
        ...
        const course = await course_model_1.default.create(courseSeed.course);
        let totalTopics = 0;
