...
exports.run = exports.promptCourseTopics = exports.promptCourseChapters = void 0;
...
const run = async () => {
    try {
        ...
        await Promise.all([
            ...
            chapter_model_1.default.deleteMany({ course: existingCourse._id }),
        ]);
        ...
        const chapters = await chapter_model_1.default.create(exports.promptCourseChapters.map((ch) => ({
        ...
        for (let i = 0; i < exports.promptCourseTopics.length; i++) {
            const topicSeed = exports.promptCourseTopics[i];
            ...
            if (topicSeed.flashcards.length > 0) {
                await flashcard_model_1.default.insertMany(topicSeed.flashcards.map((f) => ({
                    topic: topic._id,
                    question: f.question,
                    answer: f.answer,
                })));
            ...
            if (topicSeed.mcqs.length > 0) {
                await mcq_model_1.default.insertMany(topicSeed.mcqs.map((m) => ({
                    topic: topic._id,
                    question: m.question,
                    options: m.options,
