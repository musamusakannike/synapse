...
const aiMlCourseSeed: { course: Partial<ICourse>; topics: TopicSeed[] } = {
  course: {
    ...
    longDescription:
      'A beginner-friendly, hands-on introduction to Artificial Intelligence and Machine Learning. Learn how to prepare data, train smart prediction models, evaluate results, and build real-world projects — using Google Colab, VS Code, or your mobile phone with Pydroid 3.',
  ...
  topics: [
    {
      ...
      contents: [
        ...
        },
        {
          ...
          content:
            "Scikit-Learn (sklearn) is the premier Python library for Machine Learning. It comes pre-installed in Google Colab!\n\nLet's write a quick script to load the Iris Flower Dataset — a dataset containing 150 flower samples.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Machine learning models love numbers! NumPy handles lists of numbers (arrays), while Pandas handles tables of data (DataFrames) like Excel spreadsheets.\n\nPandas makes loading datasets super simple:\nimport pandas as pd\ndf = pd.read_csv('dataset.csv')\nprint(df.head())",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Real-world data often has empty spots (missing values). Scikit-Learn models crash if you feed them missing numbers! We fill missing spots using an Imputer.\n\nSimpleImputer fills empty spots with the average (mean) or middle (median) value of that column.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Computers only understand numbers. If your dataset has words like ['Red', 'Green', 'Blue'], we turn each color into its own 1 or 0 column!\n\nThis is called One-Hot Encoding:\n- Red   -> [1, 0, 0]\n- Green -> [0, 1, 0]\n- Blue  -> [0, 0, 1]",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Linear Regression finds the best straight line through your data points to predict continuous numbers (like house prices, temperature, or salary).\n\nLine equation: Price = (Slope * Size) + Starting Price",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Overfitting happens when a model memorizes the training data too hard (like memorizing exam answers instead of understanding concepts). Regularization forces the model to stay simple and generalize better to new data!\n\n- Ridge ($L_2$): Shrinks large feature weights.\n- Lasso ($L_1$): Shrinks unimportant feature weights to zero.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Congratulations on reaching your first project! You will load a real housing dataset, split data, train a Linear Regression model, evaluate its predictions, and calculate the RMSE score.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "K-Nearest Neighbors (KNN): Classifies a new sample by looking at the K closest items around it ('birds of a feather flock together').\n\nSupport Vector Machines (SVM): Draws a wide safety street (margin) separating different categories.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "In this project, you will build a classification model to spot customers who are about to cancel their subscription (churn). Early warning lets companies send discount offers!",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "A single decision tree can make mistakes. A Random Forest trains 100+ decision trees on random subsets of data and takes a majority vote! This makes Random Forests one of the most powerful and reliable algorithms in all of ML.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "In Bagging (Random Forest), trees are built independently in parallel. In Boosting, trees are built sequentially one after another — each new tree focuses on fixing the mistakes of the previous tree!",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "Instead of manually running imputer -> scaler -> model on train data and repeating on test data, a Scikit-Learn `Pipeline` bundles everything into one single object!",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "You will build an end-to-end credit risk classifier for loan applications, wrap it in a Pipeline, optimize parameters, and export `credit_model.joblib` to disk.",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "In Unsupervised Learning, there are no target answers ($y$)! The model looks for hidden clusters and natural patterns in features ($X$).\n\nK-Means divides data into K cluster groups around center points (centroids).",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "If your dataset has 50 columns, it is hard to plot or process. Principal Component Analysis (PCA) combines 50 columns down to 2 or 3 super-columns while keeping most of the information!",
        },
        {
          type: 'code',
          title: 'Using PCA',
      ...
      contents: [
        {
          ...
          content:
            "You will take customer transaction features, apply StandardScaler, compress data with PCA, and run K-Means to discover distinct customer groups (e.g. VIP Spenders vs Occasional Buyers).",
        },
        {
          type: 'code',
      ...
      contents: [
        {
          ...
          content:
            "You made it to the final module! In this capstone project, you will combine all 23 modules to build a production model, save it, and load it in an interactive app script (using Streamlit or a Python script on Colab/Pydroid 3).\n\nCongratulations on completing your journey into AI & Machine Learning with Scikit-Learn!",
        },
        {
          type: 'code',
...
const run = async (): Promise<void> => {
  try {
    ...
    const existingCourse = await Course.findOne({ title: aiMlCourseSeed.course.title });
